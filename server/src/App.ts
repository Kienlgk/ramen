...
export default class App {
    ...
    constructor(options) {
        ...
        var test = require('./jobs/db_init.js');
        test();
    }
    ...
    private middleware(options): void {
        ...
        this.express.use(session({ secret: 'iwaiter@ramencs.vn', cookie: {
          maxAge: 24 * 60 * 60000
        }}));
    }
...
function acceptCors(req, res, next) {
    ...
    res.header("Access-Control-Allow-Headers", "Accept, Origin, Content-Type, Access-Control-Allow-Headers, Authorization, X-Requested-With");
